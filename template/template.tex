...
\pagestyle{plain}
\def \report_title {LaTeX Template For an iDSI Technical Report}
...
\title{LaTeX Template For an iDSI Technical Report}

\begin{abstract}
Here is my very important research that I worked very hard on and because I am brilliant the work will you will read below will change your life in unimaginable ways. Well at least until you die, then it will change the lives of your posterity until the end of your family line.
\end{abstract}
...
{\huge \bfseries LaTeX Template For an iDSI Technical Report } \\[0.4cm] \HRule \\[1.5cm]
\Large \emph{Author:}\\ Cameron Dart\\[3cm]
{\large \today}\\[3cm] % Date
